...
public class Constants {
	...
	public static final String TEST_CASE_RUNMODE_YES = "Yes";
	public static final String TEST_CASE_RUNMODE_NO = "No";
	...
	public static final String TEST_DATA_FILE_NAME = "TestDataSheetName";
	...
	public static final String ENTERPRISE_IDS_LIST = "enterpriseIds";
	public static final String ENTERPRISE_GUID_KEY = "enterprise_guid";
